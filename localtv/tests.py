...
<li>00:30:00 -- Wrapping up</li>
    ...
    def test_entries_atom_from_mc(self):
        ...
        video = models.Video.objects.order_by('id')[0]
        self.assertEquals(video.feed, feed)
        self.assertEquals(video.guid, u'http://www.onnetworks.com/5843 at http://www.onnetworks.com')
        self.assertEquals(video.name, u'The Dancer: Kenaudra')
        self.assertEquals(video.when_published, datetime.datetime(2009, 1, 13, 6, 0))
        self.assertEquals(video.file_url, u'http://podcast.onnetworks.com/videos/sgatp_0108_kenaudra_480x270.mp4?feed=video&key=6100&target=itunes')
        self.assertEquals(video.file_url_length, 1)
        self.assertEquals(video.file_url_mimetype, u'video/mp4')
        self.assertEquals(video.website_url, u'http://www.onnetworks.com/videos/smart-girls-at-the-party/the-dancer-kenaudra')
        self.assertEquals(video.description, u'Kenaudra displays her many talents including a new dance called Praise Dancing.<br /><a href="http://www.onnetworks.com/videos/smart-girls-at-the-party/the-dancer-kenaudra"></a>')
        self.assertEquals(video.embed_code, u"""<object width="425" height="271"><embed id="ONPlayerEmbed" width="425" height="271" allowfullscreen="true" flashvars="configFileName=http://www.onnetworks.com/embed_player/videos/smart-girls-at-the-party/the-dancer-kenaudra?target=site" scale="aspect" allowscriptaccess="always" allownetworking="all" quality="high" bgcolor="#ffffff" name="ONPlayer" style="" src="http://www.onnetworks.com/swfs/ONPlayerEmbed.swf/product_id=sgatp_0108_kenaudra/cspid=4b2678259ccf1f2b" type="application/x-shockwave-flash"></embed></object>""")
