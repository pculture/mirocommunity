...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Contest.max_votes'
        db.delete_column('contests_contest', 'max_votes')

        # Adding field 'Contest.description'
        db.add_column('contests_contest', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Contest.homepage_columns'
        db.add_column('contests_contest', 'homepage_columns',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Contest.votes_per_user'
        db.add_column('contests_contest', 'votes_per_user',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Contest.submissions_open'
        db.add_column('contests_contest', 'submissions_open',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Contest.voting_open'
        db.add_column('contests_contest', 'voting_open',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Contest.display_vote_counts'
        db.add_column('contests_contest', 'display_vote_counts',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        # Adding M2M table for field videos on 'Contest'
        db.create_table('contests_contest_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contest', models.ForeignKey(orm['contests.contest'], null=False)),
            ('video', models.ForeignKey(orm['localtv.video'], null=False))
        ))
        db.create_unique('contests_contest_videos', ['contest_id', 'video_id'])

    def backwards(self, orm):
        # Adding field 'Contest.max_votes'
        db.add_column('contests_contest', 'max_votes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Contest.description'
        db.delete_column('contests_contest', 'description')

        # Deleting field 'Contest.homepage_columns'
        db.delete_column('contests_contest', 'homepage_columns')

        # Deleting field 'Contest.votes_per_user'
        db.delete_column('contests_contest', 'votes_per_user')

        # Deleting field 'Contest.submissions_open'
        db.delete_column('contests_contest', 'submissions_open')

        # Deleting field 'Contest.voting_open'
        db.delete_column('contests_contest', 'voting_open')

        # Deleting field 'Contest.display_vote_counts'
        db.delete_column('contests_contest', 'display_vote_counts')
        ...
        # Removing M2M table for field videos on 'Contest'
        db.delete_table('contests_contest_videos')
    ...
    models = {
        ...
        'contests.contest': {
            ...
            'homepage_columns': ('django.db.models.fields.CommaSeparatedIntegerField', [], {'max_length': '10', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'submissions_open': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'videos': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['localtv.Video']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'contests.contestvote': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'votes'", 'to': "orm['contests.Contest']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
