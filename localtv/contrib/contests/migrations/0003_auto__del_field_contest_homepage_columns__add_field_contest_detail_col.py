...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contest.detail_columns'
        db.add_column('contests_contest', 'detail_columns',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Contest.detail_columns'
        db.delete_column('contests_contest', 'detail_columns')
