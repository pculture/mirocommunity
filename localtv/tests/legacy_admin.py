...
class SourcesAdministrationTestCase(AdministrationBaseTestCase):
    ...
    def test_POST_succeed(self):
        ...
        feed.thumbnail_file = File(file(self._data_file('logo.png')))
        feed.save()
        ...
        self.assertFalse(feed.thumbnail_file)
        ...
        self.assertTrue(search.thumbnail_file)
