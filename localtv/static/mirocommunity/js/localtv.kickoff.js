	...
	$('[title]').tooltip({
		placement: function(a, element){
			var $element = $(element),
				...
				dummy = $('<div class="tooltip">' + title + '</div>');
			...
			// distance from edge of hover element + width of hover element + width of tooltip
			if (offset.left + $element.width() + (width / 2) > $(window).width()) {
				return 'left';
			}
