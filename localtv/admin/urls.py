...
urlpatterns = patterns('',
    url(r'^$', ViewNameRedirectView.as_view(view_name=ADMIN_ROOT_VIEW),
    ...
    url(r'^profile/$',
        ViewNameRedirectView.as_view(view_name='localtv_admin_profile'),
        name='localtv_user_profile'),
    url(r'^playlists/$',
        ViewNameRedirectView.as_view(view_name='localtv_admin_playlist_list'),
