...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TierInfo.already_sent_tiers_compliance_email'
        db.add_column('localtv_tierinfo', 'already_sent_tiers_compliance_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TierInfo.already_sent_tiers_compliance_email'
        db.delete_column('localtv_tierinfo', 'already_sent_tiers_compliance_email')
