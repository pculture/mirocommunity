...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OriginalVideo.remote_video_was_deleted'
        db.add_column('localtv_originalvideo', 'remote_video_was_deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OriginalVideo.remote_video_was_deleted'
        db.delete_column('localtv_originalvideo', 'remote_video_was_deleted')
