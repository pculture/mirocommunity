...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteLocation.hide_get_started'
        db.add_column('localtv_sitelocation', 'hide_get_started', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SiteLocation.hide_get_started'
        db.delete_column('localtv_sitelocation', 'hide_get_started')
