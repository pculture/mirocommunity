...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TierInfo.free_trial_started_on'
        db.add_column('localtv_tierinfo', 'free_trial_started_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TierInfo.free_trial_started_on'
        db.delete_column('localtv_tierinfo', 'free_trial_started_on')
