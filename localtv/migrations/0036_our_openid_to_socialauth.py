...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for oid_user in orm['localtv_openid.OpenIdUser'].objects.all():
            orm['socialauth.OpenidProfile'].objects.create(
                user=oid_user.user,
                openid_key=oid_user.url,
                email=oid_user.user.email,
                is_username_valid=True,
                nickname=oid_user.user.username)
    ...
    models = {
        ...
        'localtv_openid.openiduser': {
            'Meta': {'db_table': "'localtv_openiduser'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
