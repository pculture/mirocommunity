...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SiteSettings.tier_name'
    ...
    def backwards(self, orm):
        ...
        db.send_create_signal('localtv', ['TierInfo'])

        # Adding field 'SiteSettings.tier_name'
        db.add_column('localtv_sitelocation', 'tier_name',
