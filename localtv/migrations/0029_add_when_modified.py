...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.when_modified'
        db.add_column('localtv_video', 'when_modified', orm['localtv.video:when_modified'])
        
    
    def backwards(self, orm):
        
        # Deleting field 'Video.when_modified'
        db.delete_column('localtv_video', 'when_modified')
