...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('localtv_profile', 'location', orm['localtv.profile:location'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('localtv_profile', 'location')
    ...
    models = {
        ...
        'localtv.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True', 'default': "''"}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
