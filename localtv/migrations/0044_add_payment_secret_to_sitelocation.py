...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('localtv_sitelocation', 'payment_secret', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)
    ...
    models = {
        ...
        'localtv.sitelocation': {
            ...
            'payment_secret': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
