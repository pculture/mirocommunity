...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localtv_categoryvideo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localtv.Category'])),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localtv.Video'])),
        ))
        db.send_create_signal('localtv', ['CategoryVideo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('localtv_categoryvideo')
        ...
        db.create_unique('localtv_video_categories', ['video_id', 'category_id'])
