...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TierInfo.payment_due_date'
        db.add_column('localtv_tierinfo', 'payment_due_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'TierInfo.free_trial_available'
        db.add_column('localtv_tierinfo', 'free_trial_available', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'TierInfo.in_free_trial'
        db.add_column('localtv_tierinfo', 'in_free_trial', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TierInfo.payment_secret'
        db.add_column('localtv_tierinfo', 'payment_secret', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'TierInfo.current_paypal_profile_id'
        db.add_column('localtv_tierinfo', 'current_paypal_profile_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'TierInfo.video_allotment_warning_sent'
        db.add_column('localtv_tierinfo', 'video_allotment_warning_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TierInfo.free_trial_warning_sent'
        db.add_column('localtv_tierinfo', 'free_trial_warning_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TierInfo.already_sent_welcome_email'
        db.add_column('localtv_tierinfo', 'already_sent_welcome_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TierInfo.inactive_site_warning_sent'
        db.add_column('localtv_tierinfo', 'inactive_site_warning_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TierInfo.payment_due_date'
        db.delete_column('localtv_tierinfo', 'payment_due_date')

        # Deleting field 'TierInfo.free_trial_available'
        db.delete_column('localtv_tierinfo', 'free_trial_available')

        # Deleting field 'TierInfo.in_free_trial'
        db.delete_column('localtv_tierinfo', 'in_free_trial')

        # Deleting field 'TierInfo.payment_secret'
        db.delete_column('localtv_tierinfo', 'payment_secret')

        # Deleting field 'TierInfo.current_paypal_profile_id'
        db.delete_column('localtv_tierinfo', 'current_paypal_profile_id')

        # Deleting field 'TierInfo.video_allotment_warning_sent'
        db.delete_column('localtv_tierinfo', 'video_allotment_warning_sent')

        # Deleting field 'TierInfo.free_trial_warning_sent'
        db.delete_column('localtv_tierinfo', 'free_trial_warning_sent')

        # Deleting field 'TierInfo.already_sent_welcome_email'
        db.delete_column('localtv_tierinfo', 'already_sent_welcome_email')

        # Deleting field 'TierInfo.inactive_site_warning_sent'
        db.delete_column('localtv_tierinfo', 'inactive_site_warning_sent')
