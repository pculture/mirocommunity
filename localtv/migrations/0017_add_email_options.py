...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteLocation.email_review_status'
        db.add_column('localtv_sitelocation', 'email_review_status', orm['localtv.sitelocation:email_review_status'])
        
        # Adding field 'SiteLocation.email_on_new_video'
        db.add_column('localtv_sitelocation', 'email_on_new_video', orm['localtv.sitelocation:email_on_new_video'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SiteLocation.email_review_status'
        db.delete_column('localtv_sitelocation', 'email_review_status')
        
        # Deleting field 'SiteLocation.email_on_new_video'
        db.delete_column('localtv_sitelocation', 'email_on_new_video')
