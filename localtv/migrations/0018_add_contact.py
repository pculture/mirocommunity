...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.contact'
        db.add_column('localtv_video', 'contact', orm['localtv.video:contact'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.contact'
        db.delete_column('localtv_video', 'contact')
