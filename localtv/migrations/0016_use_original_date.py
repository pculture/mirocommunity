...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteLocation.use_original_date'
        db.add_column('localtv_sitelocation', 'use_original_date', orm['localtv.sitelocation:use_original_date'])
        
    def backwards(self, orm):
        
        # Deleting field 'SiteLocation.use_original_date'
        db.delete_column('localtv_sitelocation', 'use_original_date')
