...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('localtv_sitesettings', 'footer_html', 'footer_content')
        db.rename_column('localtv_sitesettings', 'about_html', 'site_description')
        db.rename_column('localtv_sitesettings', 'display_submit_button', 'submission_allowed')

        # Adding field 'SiteSettings.logo_contains_site_name'
        db.add_column('localtv_sitesettings', 'logo_contains_site_name',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SiteSettings.google_analytics_ua'
        db.add_column('localtv_sitesettings', 'google_analytics_ua',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'SiteSettings.google_analytics_domain'
        db.add_column('localtv_sitesettings', 'google_analytics_domain',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'SiteSettings.facebook_admins'
        db.add_column('localtv_sitesettings', 'facebook_admins',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        db.rename_column('localtv_sitesettings', 'footer_content', 'footer_html')
        db.rename_column('localtv_sitesettings', 'site_description', 'about_html')
        db.rename_column('localtv_sitesettings', 'submission_allowed', 'display_submit_button')

        # Deleting field 'SiteSettings.logo_contains_site_name'
        db.delete_column('localtv_sitesettings', 'logo_contains_site_name')

        # Deleting field 'SiteSettings.google_analytics_ua'
        db.delete_column('localtv_sitesettings', 'google_analytics_ua')

        # Deleting field 'SiteSettings.google_analytics_domain'
        db.delete_column('localtv_sitesettings', 'google_analytics_domain')

        # Deleting field 'SiteSettings.facebook_admins'
        db.delete_column('localtv_sitesettings', 'facebook_admins')
    ...
    models = {
        ...
        'localtv.sitesettings': {
            ...
            'facebook_admins': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'footer_content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'google_analytics_domain': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'google_analytics_ua': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'hide_get_started': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'logo_contains_site_name': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'submission_allowed': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
