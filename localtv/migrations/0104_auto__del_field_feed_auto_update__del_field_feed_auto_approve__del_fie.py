...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Feed.auto_update'
        db.delete_column('localtv_feed', 'auto_update')

        # Deleting field 'Feed.auto_approve'
        db.delete_column('localtv_feed', 'auto_approve')

        # Deleting field 'SavedSearch.auto_approve'
        db.delete_column('localtv_savedsearch', 'auto_approve')

        # Deleting field 'SavedSearch.auto_update'
        db.delete_column('localtv_savedsearch', 'auto_update')


    def backwards(self, orm):
        # Adding field 'Feed.auto_update'
        db.add_column('localtv_feed', 'auto_update',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Feed.auto_approve'
        db.add_column('localtv_feed', 'auto_approve',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SavedSearch.auto_approve'
        db.add_column('localtv_savedsearch', 'auto_approve',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SavedSearch.auto_update'
        db.add_column('localtv_savedsearch', 'auto_update',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
