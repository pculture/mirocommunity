...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SiteSettings.status'
        db.delete_column('localtv_sitesettings', 'status')


    def backwards(self, orm):
        # Adding field 'SiteSettings.status'
        db.add_column('localtv_sitesettings', 'status',
