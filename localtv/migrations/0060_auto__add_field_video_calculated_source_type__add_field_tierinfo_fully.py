...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TierInfo.fully_confirmed_tier_name'
        db.add_column('localtv_tierinfo', 'fully_confirmed_tier_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TierInfo.fully_confirmed_tier_name'
        db.delete_column('localtv_tierinfo', 'fully_confirmed_tier_name')
