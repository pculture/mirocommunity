...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OriginalVideo.remote_thumbnail_hash'
        db.add_column('localtv_originalvideo', 'remote_thumbnail_hash', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OriginalVideo.remote_thumbnail_hash'
        db.delete_column('localtv_originalvideo', 'remote_thumbnail_hash')
