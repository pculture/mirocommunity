...
class Migration:
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SiteLocation.has_thumbnail'
        db.delete_column('localtv_sitelocation', 'has_thumbnail')
        
        # Deleting field 'SiteLocation.thumbnail_extension'
        db.delete_column('localtv_sitelocation', 'thumbnail_extension')
