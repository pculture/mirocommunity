...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SearchImportIndex.suite'
        db.delete_column('localtv_searchimportindex', 'suite')


    def backwards(self, orm):
        # Adding field 'SearchImportIndex.suite'
        db.add_column('localtv_searchimportindex', 'suite',
