...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Video.file_url_length'
        db.delete_column('localtv_video', 'file_url_length')

        # Deleting field 'Video.file_url_mimetype'
        db.delete_column('localtv_video', 'file_url_mimetype')

        # Deleting field 'Video.file_url'
        db.delete_column('localtv_video', 'file_url')


    def backwards(self, orm):
        # Adding field 'Video.file_url_length'
        db.add_column('localtv_video', 'file_url_length',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Video.file_url_mimetype'
        db.add_column('localtv_video', 'file_url_mimetype',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Video.file_url'
        db.add_column('localtv_video', 'file_url',
