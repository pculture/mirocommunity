...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('localtv_feed', 'has_thumbnail', orm['localtv.feed:has_thumbnail'])
        
        # Adding field 'SavedSearch.has_thumbnail'
        db.add_column('localtv_savedsearch', 'has_thumbnail', orm['localtv.savedsearch:has_thumbnail'])
        
        # Adding field 'Feed.thumbnail_extension'
        db.add_column('localtv_feed', 'thumbnail_extension', orm['localtv.feed:thumbnail_extension'])
        
        # Adding field 'SavedSearch.thumbnail_extension'
        db.add_column('localtv_savedsearch', 'thumbnail_extension', orm['localtv.savedsearch:thumbnail_extension'])
    ...
    models = {
        ...
        'localtv.feed': {
            ...
            'thumbnail_extension': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True', 'default': '""'}),
