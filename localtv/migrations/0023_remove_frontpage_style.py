...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SiteLocation.frontpage_style'
        db.delete_column('localtv_sitelocation', 'frontpage_style')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'SiteLocation.frontpage_style'
        db.add_column('localtv_sitelocation', 'frontpage_style', orm['localtv.sitelocation:frontpage_style'])
