...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # NOTE: This is not truly a data migration.
        # It instead asserts that your Django settings configure your time zone as UTC.
        # This is essential to storing dates properly; otherwise, the behavior of auto_now_add
        # is basically undetermined.
        from django.conf import settings
        configured_zone = getattr(settings, 'TIME_ZONE', None)
        if configured_zone != 'UTC':
            raise ValueError, "Look, the time zone has GOT to be UTC."
