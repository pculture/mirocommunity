...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localtv_videofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='files', to=orm['localtv.Video'])),
            ...
            ('mimetype', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
        ))
        db.send_create_signal('localtv', ['VideoFile'])


    def backwards(self, orm):
        # Deleting model 'VideoFile'
        db.delete_table('localtv_videofile')
