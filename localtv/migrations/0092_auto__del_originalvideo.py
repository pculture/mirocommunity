...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('localtv_originalvideo', (
            ('video', self.gf('django.db.models.fields.related.OneToOneField')(related_name='original', unique=True, to=orm['localtv.Video'])),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('thumbnail_updated', self.gf('django.db.models.fields.DateTimeField')(blank=True)),
            ('remote_video_was_deleted', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('remote_thumbnail_hash', self.gf('django.db.models.fields.CharField')(default='', max_length=64)),
            ('thumbnail_url', self.gf('django.db.models.fields.URLField')(max_length=400, blank=True)),
