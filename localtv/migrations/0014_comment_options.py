...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SiteLocation.comments_email_admins'
        db.add_column('localtv_sitelocation', 'comments_email_admins', orm['localtv.sitelocation:comments_email_admins'])
        
        # Adding field 'SiteLocation.screen_all_comments'
        db.add_column('localtv_sitelocation', 'screen_all_comments', orm['localtv.sitelocation:screen_all_comments'])
        
        # Adding field 'SiteLocation.comments_required_login'
        db.add_column('localtv_sitelocation', 'comments_required_login', orm['localtv.sitelocation:comments_required_login'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'SiteLocation.comments_email_admins'
        db.delete_column('localtv_sitelocation', 'comments_email_admins')
        
        # Deleting field 'SiteLocation.screen_all_comments'
        db.delete_column('localtv_sitelocation', 'screen_all_comments')
        
        # Deleting field 'SiteLocation.comments_required_login'
        db.delete_column('localtv_sitelocation', 'comments_required_login')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 22, 8, 29, 14, 668632)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 22, 8, 29, 14, 668485)'}),
