...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.add_column('localtv_profile', 'website', orm['localtv.profile:website'])
    ...
    def backwards(self, orm):
        ...
        db.delete_column('localtv_profile', 'website')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 10, 2, 9, 54, 43, 398499)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 10, 2, 9, 54, 43, 398374)'}),
