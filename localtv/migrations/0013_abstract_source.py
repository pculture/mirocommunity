...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SavedSearch.auto_approve'
        db.add_column('localtv_savedsearch', 'auto_approve', orm['localtv.savedsearch:auto_approve'])
        
        # Adding ManyToManyField 'SavedSearch.auto_authors'
        db.create_table('localtv_savedsearch_auto_authors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('savedsearch', models.ForeignKey(orm.SavedSearch, null=False)),
            ('user', models.ForeignKey(orm['auth.User'], null=False))
        ))
        
        # Adding ManyToManyField 'SavedSearch.auto_categories'
        db.create_table('localtv_savedsearch_auto_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('savedsearch', models.ForeignKey(orm.SavedSearch, null=False)),
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SavedSearch.auto_approve'
        db.delete_column('localtv_savedsearch', 'auto_approve')
        
        # Dropping ManyToManyField 'SavedSearch.auto_authors'
        db.delete_table('localtv_savedsearch_auto_authors')
        
        # Dropping ManyToManyField 'SavedSearch.auto_categories'
        db.delete_table('localtv_savedsearch_auto_categories')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 21, 9, 39, 5, 565253)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 21, 9, 39, 5, 565120)'}),
