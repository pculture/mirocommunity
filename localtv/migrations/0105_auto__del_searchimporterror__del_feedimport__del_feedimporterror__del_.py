...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SearchImportError'
        db.delete_table('localtv_searchimporterror')

        # Deleting model 'FeedImport'
        db.delete_table('localtv_feedimport')

        # Deleting model 'FeedImportError'
        db.delete_table('localtv_feedimporterror')
        ...
        # Adding model 'SourceImport'
        db.create_table('localtv_sourceimport', (
            ...
            ('import_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ...
        db.send_create_signal('localtv', ['SourceImport'])

        # Adding model 'SourceImportIdentifier'
        db.create_table('localtv_sourceimportidentifier', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identifier_hash', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('source_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('source_content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
        ))
        db.send_create_signal('localtv', ['SourceImportIdentifier'])

        # Adding model 'SourceImportStep'
        db.create_table('localtv_sourceimportstep', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('step_type', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('video', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['localtv.Video'], unique=True, null=True, on_delete=models.SET_NULL, blank=True)),
            ('traceback', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('source_import', self.gf('django.db.models.fields.related.ForeignKey')(related_name='steps', to=orm['localtv.SourceImport'])),
        ))
        db.send_create_signal('localtv', ['SourceImportStep'])

        # Adding field 'Feed.update_metadata'
        db.add_column('localtv_feed', 'update_metadata',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'SearchImportError'
        db.create_table('localtv_searchimporterror', (
            ('traceback', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('source_import', self.gf('django.db.models.fields.related.ForeignKey')(related_name='errors', to=orm['localtv.SearchImport'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('is_skip', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('localtv', ['SearchImportError'])
        ...
        db.create_table('localtv_feedimport', (
            ...
            ('total_videos', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='imports', to=orm['localtv.Feed'])),
        ...
        # Adding model 'FeedImportError'
        db.create_table('localtv_feedimporterror', (
            ('traceback', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('source_import', self.gf('django.db.models.fields.related.ForeignKey')(related_name='errors', to=orm['localtv.FeedImport'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('is_skip', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('localtv', ['FeedImportError'])
        ...
        db.create_table('localtv_searchimport', (
            ...
            ('last_activity', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('total_videos', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(related_name='imports', to=orm['localtv.SavedSearch'])),
            ('videos_imported', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('videos_skipped', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.create_table('localtv_feedimportindex', (
            ...
            ('source_import', self.gf('django.db.models.fields.related.ForeignKey')(related_name='indexes', to=orm['localtv.FeedImport'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        db.create_table('localtv_searchimportindex', (
            ('index', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('video', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['localtv.Video'], unique=True)),
            ('source_import', self.gf('django.db.models.fields.related.ForeignKey')(related_name='indexes', to=orm['localtv.SearchImport'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('localtv', ['SearchImportIndex'])

        # Deleting model 'SourceImport'
        db.delete_table('localtv_sourceimport')

        # Deleting model 'SourceImportIdentifier'
        db.delete_table('localtv_sourceimportidentifier')

        # Deleting model 'SourceImportStep'
        db.delete_table('localtv_sourceimportstep')

        # Deleting field 'Feed.update_metadata'
        db.delete_column('localtv_feed', 'update_metadata')
