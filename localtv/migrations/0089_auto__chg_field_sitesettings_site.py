...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('localtv_sitesettings', 'site_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['sites.Site'], unique=True))

    def backwards(self, orm):

        # Changing field 'SiteSettings.site'
        db.alter_column('localtv_sitesettings', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], unique=True))
