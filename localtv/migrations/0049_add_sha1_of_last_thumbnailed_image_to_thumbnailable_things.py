...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.sha1_of_last_image_we_thumbnailed'
        db.add_column('localtv_video', 'sha1_of_last_image_we_thumbnailed', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'SavedSearch.sha1_of_last_image_we_thumbnailed'
        db.add_column('localtv_savedsearch', 'sha1_of_last_image_we_thumbnailed', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'SiteLocation.sha1_of_last_image_we_thumbnailed'
        db.add_column('localtv_sitelocation', 'sha1_of_last_image_we_thumbnailed', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'Feed.sha1_of_last_image_we_thumbnailed'
        db.add_column('localtv_feed', 'sha1_of_last_image_we_thumbnailed', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'WidgetSettings.sha1_of_last_image_we_thumbnailed'
        db.add_column('localtv_widgetsettings', 'sha1_of_last_image_we_thumbnailed', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)
    ...
    models = {
        ...
        'localtv.feed': {
            ...
            'sha1_of_last_image_we_thumbnailed': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
