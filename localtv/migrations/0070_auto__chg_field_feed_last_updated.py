...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('localtv_feed', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'Feed.last_updated'
        db.alter_column('localtv_feed', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 11, 29, 13, 13, 50, 175166)))
    models = {
        'auth.group': {
        ...
        'localtv.sitelocation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'playlists_enabled': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
