...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('localtv_video', 'flash_enclosure_url', self.gf('localtv.migrations.old_fields.BitLyWrappingURLField')(max_length=200), ignore_constraints=True)

        # Changing field 'Video.website_url'
        db.alter_column('localtv_video', 'website_url', self.gf('localtv.migrations.old_fields.BitLyWrappingURLField')(max_length=200), ignore_constraints=True)

        # Changing field 'Video.file_url'
        db.alter_column('localtv_video', 'file_url', self.gf('localtv.migrations.old_fields.BitLyWrappingURLField')(max_length=200), ignore_constraints=True)


    def backwards(self, orm):
        pass # no going back, *gulp*
