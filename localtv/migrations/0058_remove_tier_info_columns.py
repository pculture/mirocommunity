...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SiteLocation.payment_due_date'
        db.delete_column('localtv_sitelocation', 'payment_due_date')

        # Deleting field 'SiteLocation.inactive_site_warning_sent'
        db.delete_column('localtv_sitelocation', 'inactive_site_warning_sent')

        # Deleting field 'SiteLocation.current_paypal_profile_id'
        db.delete_column('localtv_sitelocation', 'current_paypal_profile_id')

        # Deleting field 'SiteLocation.in_free_trial'
        db.delete_column('localtv_sitelocation', 'in_free_trial')

        # Deleting field 'SiteLocation.free_trial_warning_sent'
        db.delete_column('localtv_sitelocation', 'free_trial_warning_sent')

        # Deleting field 'SiteLocation.already_sent_welcome_email'
        db.delete_column('localtv_sitelocation', 'already_sent_welcome_email')

        # Deleting field 'SiteLocation.payment_secret'
        db.delete_column('localtv_sitelocation', 'payment_secret')

        # Deleting field 'SiteLocation.video_allotment_warning_sent'
        db.delete_column('localtv_sitelocation', 'video_allotment_warning_sent')

        # Deleting field 'SiteLocation.free_trial_available'
        db.delete_column('localtv_sitelocation', 'free_trial_available')


    def backwards(self, orm):
        
        # Adding field 'SiteLocation.payment_due_date'
        db.add_column('localtv_sitelocation', 'payment_due_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'SiteLocation.inactive_site_warning_sent'
        db.add_column('localtv_sitelocation', 'inactive_site_warning_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SiteLocation.current_paypal_profile_id'
        db.add_column('localtv_sitelocation', 'current_paypal_profile_id', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'SiteLocation.in_free_trial'
        db.add_column('localtv_sitelocation', 'in_free_trial', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SiteLocation.free_trial_warning_sent'
        db.add_column('localtv_sitelocation', 'free_trial_warning_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SiteLocation.already_sent_welcome_email'
        db.add_column('localtv_sitelocation', 'already_sent_welcome_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SiteLocation.payment_secret'
        db.add_column('localtv_sitelocation', 'payment_secret', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'SiteLocation.video_allotment_warning_sent'
        db.add_column('localtv_sitelocation', 'video_allotment_warning_sent', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'SiteLocation.free_trial_available'
        db.add_column('localtv_sitelocation', 'free_trial_available', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    models = {
        ...
        'localtv.video': {
            ...
            'file_url': ('localtv.migrations.old_fields.BitLyWrappingURLField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'flash_enclosure_url': ('localtv.migrations.old_fields.BitLyWrappingURLField', [], {'max_length': '200', 'blank': 'True'}),
            ...
            'website_url': ('localtv.migrations.old_fields.BitLyWrappingURLField', [], {'max_length': '200', 'blank': 'True'}),
