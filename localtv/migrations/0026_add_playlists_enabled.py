...
class Migration:
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SiteLocation.playlists_enabled'
        db.delete_column('localtv_sitelocation', 'playlists_enabled')
    ...
    models = {
        ...
        'localtv.sitelocation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'playlists_enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
