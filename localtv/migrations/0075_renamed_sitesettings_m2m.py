...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('localtv_sitelocation_admins', 'sitelocation_id', 'sitesettings_id')

    def backwards(self, orm):
        db.rename_column('localtv_sitelocation_admins', 'sitesettings_id', 'sitelocation_id')
