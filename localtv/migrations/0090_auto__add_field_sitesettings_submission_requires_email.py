...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.submission_requires_email'
        db.add_column('localtv_sitesettings', 'submission_requires_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.submission_requires_email'
        db.delete_column('localtv_sitesettings', 'submission_requires_email')
