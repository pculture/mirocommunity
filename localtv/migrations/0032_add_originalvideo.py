...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OriginalVideo'
        db.create_table('localtv_originalvideo', (
            ('id', orm['localtv.OriginalVideo:id']),
            ('name', orm['localtv.OriginalVideo:name']),
            ('description', orm['localtv.OriginalVideo:description']),
            ('thumbnail_url', orm['localtv.OriginalVideo:thumbnail_url']),
            ('video', orm['localtv.OriginalVideo:video']),
            ('thumbnail_updated', orm['localtv.OriginalVideo:thumbnail_updated']),
        ))
        db.send_create_signal('localtv', ['OriginalVideo'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'OriginalVideo'
        db.delete_table('localtv_originalvideo')
