...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.rename_table('localtv_feed_auto_authors_user',
                        'localtv_feed_auto_authors')
        db.rename_table('localtv_video_authors_user',
                        'localtv_video_authors')
        db.rename_table('localtv_sitelocation_admins_user',
                        'localtv_sitelocation_admins')
    
    def backwards(self, orm):
        "Write your backwards migration here"
    
        db.rename_table('localtv_feed_auto_authors',
                        'localtv_feed_auto_authors_user')
        db.rename_table('localtv_video_authors',
                        'localtv_video_authors_user')
        db.rename_table('localtv_sitelocation_admins',
                        'localtv_sitelocation_admins_user')
    ...
    models = {
        ...
        'auth.user': {
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 10, 10, 15, 49, 539528)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2009, 9, 10, 10, 15, 49, 539398)'}),
