...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlaylistItem._order'
        db.alter_column('playlists_playlistitem', '_order', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Playlist.site'
        db.add_column('playlists_playlist', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=settings.SITE_ID, to=orm['sites.Site']),
                      keep_default=False)

    def backwards(self, orm):

        # Changing field 'PlaylistItem._order'
        db.alter_column('playlists_playlistitem', '_order', self.gf('django.db.models.fields.proxy.OrderWrt')())
        # Deleting field 'Playlist.site'
        db.delete_column('playlists_playlist', 'site_id')
    ...
    models = {
        ...
        'playlists.playlist': {
            'Meta': {'ordering': "['name']", 'unique_together': "[('user', 'slug'), ('user', 'name')]", 'object_name': 'Playlist'},
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'playlists'", 'symmetrical': 'False', 'through': "orm['playlists.PlaylistItem']", 'to': "orm['localtv.Video']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '80'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['sites.Site']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'playlists.playlistitem': {
            'Meta': {'ordering': "('_order',)", 'unique_together': "(('playlist', 'video'),)", 'object_name': 'PlaylistItem'},
