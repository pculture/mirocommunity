...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('playlists_playlistitem', (
            ('id', orm['playlists.PlaylistItem:id']),
            ('playlist', orm['playlists.PlaylistItem:playlist']),
            ('video', orm['playlists.PlaylistItem:video']),
            ('_order', orm['playlists.PlaylistItem:_order']),
        ))
        db.send_create_signal('playlists', ['PlaylistItem'])
        
        # Adding model 'Playlist'
        db.create_table('playlists_playlist', (
            ('id', orm['playlists.Playlist:id']),
            ('name', orm['playlists.Playlist:name']),
            ('slug', orm['playlists.Playlist:slug']),
            ('description', orm['playlists.Playlist:description']),
            ('user', orm['playlists.Playlist:user']),
        ))
        db.send_create_signal('playlists', ['Playlist'])
        
        # Creating unique_together for [playlist, video] on PlaylistItem.
        db.create_unique('playlists_playlistitem', ['playlist_id', 'video_id'])
        
        # Creating unique_together for [user, slug] on Playlist.
        db.create_unique('playlists_playlist', ['user_id', 'slug'])
        
        # Creating unique_together for [user, name] on Playlist.
        db.create_unique('playlists_playlist', ['user_id', 'name'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [user, name] on Playlist.
        db.delete_unique('playlists_playlist', ['user_id', 'name'])
        
        # Deleting unique_together for [user, slug] on Playlist.
        db.delete_unique('playlists_playlist', ['user_id', 'slug'])
        
        # Deleting unique_together for [playlist, video] on PlaylistItem.
        db.delete_unique('playlists_playlistitem', ['playlist_id', 'video_id'])
    ...
    models = {
        ...
        'localtv.video': {
            ...
            'file_url': ('localtv.migrations.old_fields.BitLyWrappingURLField', [], {'blank': 'True', 'verify_exists': 'False'}),
            ...
            'flash_enclosure_url': ('localtv.migrations.old_fields.BitLyWrappingURLField', [], {'blank': 'True', 'verify_exists': 'False'}),
            ...
            'website_url': ('localtv.migrations.old_fields.BitLyWrappingURLField', [], {'blank': 'True', 'verify_exists': 'False'}),
